		...
		<div class="GT-right">
			...
			<div class="hg1 flex">
				<div class="product">
					...
					<img alt="" src="<c:url value="/resources/theme/img/tn1.jpg" />">
				...
				<div class="product">
					<div class="product-box">
					<img alt="" src="<c:url value="/resources/theme/img/tn2.jpg" />">
				...
				<div class="product">
					<div class="product-box">
					<img alt="" src="<c:url value="/resources/theme/img/tn3.jpg" />">
				...
				<div class="product">
					<div class="product-box">
					<img alt="" src="<c:url value="/resources/theme/img/tn4.jpg" />">
