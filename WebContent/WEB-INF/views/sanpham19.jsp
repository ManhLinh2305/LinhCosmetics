		...
		<div class="GT-right">
			...
			<div class="hg1 flex">
				<div class="product">
					...
					<img alt="" src="<c:url value="/resources/theme/img/mn1.jpg" />">
				...
				<div class="product">
					<div class="product-box">
					<img alt="" src="<c:url value="/resources/theme/img/mn2.jpg" />">
				...
				<div class="product">
					<div class="product-box">
					<img alt="" src="<c:url value="/resources/theme/img/mn3.jpg" />">
				...
				<div class="product">
					<div class="product-box">
					<img alt="" src="<c:url value="/resources/theme/img/mn4.jpg" />">
			...
			<div class="hg2 flex">
				<div class="product">
					<div class="product-box ">
					<img alt="" src="<c:url value="/resources/theme/img/mn5.jpg" />">
				...
				<div class="product">
					<div class="product-box">
					<img alt="" src="<c:url value="/resources/theme/img/mn6.jpg" />">
				...
				<div class="product">
					<div class="product-box">
					<img alt="" src="<c:url value="/resources/theme/img/mn7.jpg" />">
				...
				<div class="product">
					<div class="product-box">
					<img alt="" src="<c:url value="/resources/theme/img/mn8.jpg" />">
			...
			<div class="hg3 flex">
				<div class="product">
					<div class="product-box ">
						<img alt="" src="<c:url value="/resources/theme/img/mn9.jpg" />">
						<div class="infor">
							<a href="" class="name">Bye Bye Lines Foundation</a>
							<div class="price">
								<strong class="pri">288000</strong>
				...
				<div class="product flex">
					<div class="product-box">
					<img alt="" src="<c:url value="/resources/theme/img/mn10.jpg" />">
				...
				<div class="product flex">
					<div class="product-box">
					<img alt="" src="<c:url value="/resources/theme/img/mn11.jpg" />">
				...
				<div class="product flex">
					<div class="product-box">
					<img alt="" src="<c:url value="/resources/theme/img/mn12.jpg" />">
