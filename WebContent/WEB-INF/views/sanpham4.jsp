		...
		<div class="GT-right">
			...
			<div class="hg1 flex">
				<div class="product">
					...
					<img alt="" src="<c:url value="/resources/theme/img/cs1.jpg" />">
				...
				<div class="product">
					<div class="product-box">
					<img alt="" src="<c:url value="/resources/theme/img/cs2.jpg" />">
				...
				<div class="product">
					<div class="product-box">
					<img alt="" src="<c:url value="/resources/theme/img/cs3.jpg" />">
				...
				<div class="product">
					<div class="product-box">
					<img alt="" src="<c:url value="/resources/theme/img/cs4.jpg" />">
			...
			<div class="hg2 flex">
				<div class="product">
					<div class="product-box ">
					<img alt="" src="<c:url value="/resources/theme/img/cs5.jpg" />">
				...
				<div class="product">
					<div class="product-box">
					<img alt="" src="<c:url value="/resources/theme/img/cs6.jpg" />">
				...
				<div class="product">
					<div class="product-box">
					<img alt="" src="<c:url value="/resources/theme/img/cs7.jpg" />">
				...
				<div class="product">
					<div class="product-box">
					<img alt="" src="<c:url value="/resources/theme/img/cs8.jpg" />">
			...
			<div class="hg3 flex">
				<div class="product">
					<div class="product-box ">
						<img alt="" src="<c:url value="/resources/theme/img/cs9.jpg" />">
						<div class="infor">
							<a href="" class="name">Bye Bye Lines Foundation</a>
							<div class="price">
								<strong class="pri">288000</strong>
				...
				<div class="product flex">
					<div class="product-box">
					<img alt="" src="<c:url value="/resources/theme/img/cs10.jpg" />">
				...
				<div class="product flex">
					<div class="product-box">
					<img alt="" src="<c:url value="/resources/theme/img/cs11.png" />">
				...
				<div class="product flex">
					<div class="product-box">
					<img alt="" src="<c:url value="/resources/theme/img/cs12.png" />">
