		...
		<div class="GT-right">
			...
			<div class="hg1 flex">
				<div class="product">
					...
					<img alt="" src="<c:url value="/resources/theme/img/pm1.jpg" />">
				...
				<div class="product">
					<div class="product-box">
					<img alt="" src="<c:url value="/resources/theme/img/pm2.jpg" />">
				...
				<div class="product">
					<div class="product-box">
					<img alt="" src="<c:url value="/resources/theme/img/pm3.jpg" />">
				...
				<div class="product">
					<div class="product-box">
					<img alt="" src="<c:url value="/resources/theme/img/pm4.jpg" />">
