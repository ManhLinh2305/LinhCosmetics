		...
		<div class="GT-right">
			...
			<div class="hg1 flex">
				<div class="product">
					...
					<img alt="" src="<c:url value="/resources/theme/img/kl1.jpg" />">
				...
				<div class="product">
					<div class="product-box">
					<img alt="" src="<c:url value="/resources/theme/img/kl2.jpg" />">
				...
				<div class="product">
					<div class="product-box">
					<img alt="" src="<c:url value="/resources/theme/img/kl3.jpg" />">
				...
				<div class="product">
					<div class="product-box">
					<img alt="" src="<c:url value="/resources/theme/img/kl4.jpg" />">
			...
			<div class="hg2 flex">
				<div class="product">
					<div class="product-box ">
					<img alt="" src="<c:url value="/resources/theme/img/kl5.jpg" />">
				...
				<div class="product">
					<div class="product-box">
					<img alt="" src="<c:url value="/resources/theme/img/kl6.jpg" />">
				...
				<div class="product">
					<div class="product-box">
					<img alt="" src="<c:url value="/resources/theme/img/kl7.jpg" />">
				...
				<div class="product">
					<div class="product-box">
					<img alt="" src="<c:url value="/resources/theme/img/kl8.jpg" />">
			...
			<div class="hg3 flex">
				<div class="product">
					<div class="product-box ">
						<img alt="" src="<c:url value="/resources/theme/img/kl9.jpg" />">
						<div class="infor">
							<a href="" class="name">Bye Bye Lines Foundation</a>
							<div class="price">
								<strong class="pri">288000</strong>
				...
				<div class="product flex">
					<div class="product-box">
					<img alt="" src="<c:url value="/resources/theme/img/kl11.jpg" />">
				...
				<div class="product flex">
					<div class="product-box">
					<img alt="" src="<c:url value="/resources/theme/img/kl12.png" />">
				...
				<div class="product flex">
					<div class="product-box">
					<img alt="" src="<c:url value="/resources/theme/img/kl13.png" />">
