...
<link href="<c:url value="/resources/theme/css/dieukhoan.css"/>"
	rel="stylesheet">
      ...
      <div class="GT-right">
        ...
        <div class="gt-content">
          <div class="gt-content1">
            <p class="td1">I. Hướng dẫn sử dụng web</p>
            ...
            <ul>
              ...
              <li>
                ...
                là ý kiến cá nhân của khách hàng, không phải của chúng tôi.
              </li>
              <li>
          ...
          <div class="gt-content3">
            ...
            <p class="td5">
              ...
              phần mềm cơ bản đều là tài sản của chúng tôi. Toàn bộ nội dung của
              trang web được bảo vệ bởi luật bản quyền của Việt Nam và các công
              ước quốc tế. Bản quyền đã được bảo lưu.
            </p>
          </div>
          <div class="gt-content4">
            ...
            <p class="td7">
              ...
              sẽ giải quyết bất kỳ tranh chấp nào phát sinh từ việc sử dụng trái
              phép trang web này.
            </p>
          </div>
        </div>
