		...
		<div class="GT-right">
			...
			<div class="hg1 flex">
				<div class="product">
					...
					<img alt="" src="<c:url value="/resources/theme/img/srm10.jpg" />">
				...
				<div class="product">
					<div class="product-box">
					<img alt="" src="<c:url value="/resources/theme/img/srm2.jpg" />">
				...
				<div class="product">
					<div class="product-box">
					<img alt="" src="<c:url value="/resources/theme/img/srm3.jpg" />">
				...
				<div class="product">
					<div class="product-box">
					<img alt="" src="<c:url value="/resources/theme/img/srm4.jpg" />">
			...
			<div class="hg2 flex">
				<div class="product">
					<div class="product-box ">
					<img alt="" src="<c:url value="/resources/theme/img/srm5.jpg" />">
				...
				<div class="product">
					<div class="product-box">
					<img alt="" src="<c:url value="/resources/theme/img/srm6.jpg" />">
				...
				<div class="product">
					<div class="product-box">
					<img alt="" src="<c:url value="/resources/theme/img/srm7.jpg" />">
				...
				<div class="product">
					<div class="product-box">
					<img alt="" src="<c:url value="/resources/theme/img/srm8.jpg" />">
			...
			<div class="hg3 flex">
				<div class="product">
					<div class="product-box ">
						<img alt="" src="<c:url value="/resources/theme/img/srm11.jpg" />">
						<div class="infor">
							<a href="" class="name">Bye Bye Lines Foundation</a>
							<div class="price">
								<strong class="pri">288000</strong>
				...
				<div class="product flex">
					<div class="product-box">
					<img alt="" src="<c:url value="/resources/theme/img/srm12.jpg" />">
				...
				<div class="product flex">
					<div class="product-box">
					<img alt="" src="<c:url value="/resources/theme/img/srm13.jpg" />">
				...
				<div class="product flex">
					<div class="product-box">
					<img alt="" src="<c:url value="/resources/theme/img/srm14.jpg" />">
