		...
		<div class="GT-right">
			...
			<div class="hg1 flex">
				<div class="product">
					...
					<img alt="" src="<c:url value="/resources/theme/img/mnm1.jpg" />">
				...
				<div class="product">
					<div class="product-box">
					<img alt="" src="<c:url value="/resources/theme/img/mnm2.jpg" />">
				...
				<div class="product">
					<div class="product-box">
					<img alt="" src="<c:url value="/resources/theme/img/mnm3.jpg" />">
